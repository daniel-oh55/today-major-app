// SportsDataIO API provider — skeleton
...
export class SportsDataIOProvider implements BaseballDataProvider {
  readonly metadata: ProviderMetadata = PROVIDER_METADATA.sportsdataio_skeleton;

  constructor(private readonly apiKey: string) {}

  async getGamesByDate(_params: GetGamesByDateParams): Promise<AppGame[]> {
    throw new AppDataError("provider_unavailable", this.metadata.id, "SportsDataIOProvider: not implemented");
  }
