// Sportradar API provider — skeleton
...
export class SportradarProvider implements BaseballDataProvider {
  readonly metadata: ProviderMetadata = PROVIDER_METADATA.sportradar_skeleton;

  constructor(private readonly apiKey: string) {}

  async getGamesByDate(_params: GetGamesByDateParams): Promise<AppGame[]> {
    throw new AppDataError("provider_unavailable", this.metadata.id, "SportradarProvider: not implemented");
  }
